...
const contractABI = require("../artifacts/contracts/Chainlinkfeed.sol/Chainlinkfeed.json").abi;

program
    .name("chainlinkfeed-cli")
    .description("CLI tool for Chainlinkfeed smart contract")
    .version("1.0.0");
